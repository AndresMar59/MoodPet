...
{
    /// <inheritdoc />
    public partial class ReModel_init : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorialTarea", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistorialTarea_TareasDiarias_TareaId",
                        column: x => x.TareaId,
                        principalTable: "TareasDiarias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventosCalendario_TipoEventoId",
                table: "EventosCalendario",
                column: "TipoEventoId");
